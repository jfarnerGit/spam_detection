...
for i in range(num_folds):
    ...
    classifier = LogisticRegression_classifier.train(cv_test)
    ...
    print('FOLD ' + str(i))
    print('For this fold:')
    print('Accuracy on Fold Test Set: ' + str(nltk.classify.accuracy(LogisticRegression_classifier, cv_test)) * 100)
